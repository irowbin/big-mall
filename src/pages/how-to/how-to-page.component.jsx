      ...
      <div className="container pt-2">
        <div className="list-group">
          <span className="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <p className="mb-1">
              Clicking on <b>Navbar</b> link will navigates to the different
              pages.
            </p>
            <p className="mb-1">
          ...
          <span className="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <p className="mb-1">Sign in from the signing form.</p>
            <p className="mb-1">Use google account to signing in.</p>
          </span>
          <span className="list-group-item list-group-item-action flex-column align-items-start">
            <div className="d-flex w-100 justify-content-between">
            ...
            <p className="mb-1">
              Clicking on <b>&#10096; Or &#10095;</b> will decrease and/or
              increase cart items .
            </p>
            <p className="mb-1">
              Clicking on <b>Shop Now</b> will navigates on the product list.
          ...
          <span className="list-group-item list-group-item-action flex-column align-items-start">
            ...
            <p className="mb-1">
              Add shipping/billing info and clicking on <b>Payment Info</b>{' '}
              takes you to the next UI.
            </p>
            <p className="mb-1">
              Clicking on <b>Pay Now </b>of stripe UI will completes the
              payment.
            </p>
          </span>
        </div>
